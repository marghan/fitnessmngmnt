...
describe ClientsController do
  ...
  let(:valid_attributes) { { "ClientID" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved client as @client" do
        ...
        post :create, {:client => { "ClientID" => "invalid value" }}, valid_session
        assigns(:client).should be_a_new(Client)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested client" do
        ...
        Client.any_instance.should_receive(:update).with({ "ClientID" => "1" })
        put :update, {:id => client.to_param, :client => { "ClientID" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the client as @client" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Client.any_instance.stub(:save).and_return(false)
        put :update, {:id => client.to_param, :client => { "ClientID" => "invalid value" }}, valid_session
        assigns(:client).should eq(client)
      end
