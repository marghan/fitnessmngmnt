...
describe TrainersController do
  ...
  let(:valid_attributes) { { "trainerID" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved trainer as @trainer" do
        ...
        post :create, {:trainer => { "trainerID" => "invalid value" }}, valid_session
        assigns(:trainer).should be_a_new(Trainer)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested trainer" do
        ...
        Trainer.any_instance.should_receive(:update).with({ "trainerID" => "1" })
        put :update, {:id => trainer.to_param, :trainer => { "trainerID" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the trainer as @trainer" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Trainer.any_instance.stub(:save).and_return(false)
        put :update, {:id => trainer.to_param, :trainer => { "trainerID" => "invalid value" }}, valid_session
        assigns(:trainer).should eq(trainer)
      end
