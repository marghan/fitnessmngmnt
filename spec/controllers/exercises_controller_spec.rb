...
describe ExercisesController do
  ...
  let(:valid_attributes) { { "exerciseID" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved exercise as @exercise" do
        ...
        post :create, {:exercise => { "exerciseID" => "invalid value" }}, valid_session
        assigns(:exercise).should be_a_new(Exercise)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested exercise" do
        ...
        Exercise.any_instance.should_receive(:update).with({ "exerciseID" => "1" })
        put :update, {:id => exercise.to_param, :exercise => { "exerciseID" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the exercise as @exercise" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Exercise.any_instance.stub(:save).and_return(false)
        put :update, {:id => exercise.to_param, :exercise => { "exerciseID" => "invalid value" }}, valid_session
        assigns(:exercise).should eq(exercise)
      end
